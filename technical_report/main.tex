...
\begin{table}[h]
    ...
    \begin{tabular}{@{}p{0.24\linewidth}p{0.70\linewidth}@{}}
        ...
        \midrule
        Conversation & ASR $\rightarrow$ LLM $\rightarrow$ DataQuery $\times 2$ $\rightarrow$ TTS \\
        Parallel humanoid & ASR $\rightarrow$ LLM $\rightarrow$ DataQuery $\rightarrow$ Dispatch $\rightarrow$ (MotionGeneration $\|$ TTS) $\rightarrow$ Receive $\rightarrow$ Pad \\
